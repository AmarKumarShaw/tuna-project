...
const Navbar = () => {
    ...
    return (
        <header className="text-gray-600 body-font shadow-md lg:h-[12vh] md:h-[16vh] sm:h-[30vh]">
            <div className="container-fluid mx-auto flex flex-wrap p-3 md:p-5 flex-col md:flex-row items-center lg:px-44 md:px-12">
                <img
                    className="cursor-pointer"
                    onClick={handleClickHome}
                    src="./images/Tastebites.svg"
                    alt="logo-img"
                />
                <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center font-bold">
                    <Link to="/" className="mr-4 md:mr-10 hover:text-gray-900 cursor-pointer">
                        Home
                    </Link>
                    <Link to="/about" className="mr-4 md:mr-10 hover:text-gray-900 cursor-pointer">
                        About Us
                    </Link>
                    <Link to="/contact" className="mr-4 md:mr-10 hover:text-gray-900 cursor-pointer">
                        Contact
                    </Link>
                </nav>
                <button
                    className="inline-flex text-white items-center bg-gray-700 border-0 py-2 px-4 md:py-3 md:px-3 focus:outline-none rounded text-base mt-4 md:mt-0 cursor-pointer"
                    onClick={handleClick}
                >
                    Login/Register{' '}
                    <svg
