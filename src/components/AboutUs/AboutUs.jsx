    ...
    return (
        <div>
            <div className="px-4 py-6 lg:px-44">
                <div className="flex flex-col lg:flex-row justify-between shadow-xl p-4 md:flex-col sm:flex-col">
                    <div className="mb-4">
                        <img className="sm:object-cover lg:h-96 sm:h-48 w-full" src="./images/Onion.png" alt="" />
                    </div>
                    <div className="max-w-2xl lg:text-left md:text-center sm:text-center">
