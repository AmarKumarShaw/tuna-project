            ...
            <div className='flex flex-col lg:flex-row justify-between items-center lg:h-[80vh] pl-4 md:pl-8 lg:pl-44 sm:py-8'>
                <div className='flex flex-col items-start justify-start lg:px-8'>
                    <div className='flex flex-col'>
                        ...
                        <div className='flex'>
                            <hr class="w-24 md:w-32 lg:w-72 h-1 bg-red-500 border-0 rounded text-left" />
                        </div>
                        <div>
                            <p className='text-base text-gray-500 lg:w-full text-left my-8'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alte. </p>
                        </div>
                    </div>
                    <div className='flex items-start'>
                        <form>
                            ...
                            <button className="bg-black text-white flex px-6 py-2 cursor-pointer">Login</button>
                            <p className="text-start py-2">Don't have an account? <button className='font-bold hover:underline' onClick={handleClick}>Register Now</button></p>
                        </form>
                    </div>
                </div>
